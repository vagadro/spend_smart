...
\"I've finished implementing the POST /login route with credential validation and session handling.
...
2. A run command showing exactly how to execute the new tests

Update your agent memory as you write tests for Spendly features. 3. This builds up institutional knowledge about the test suite across conversations. Write concise notes about what you discover.
